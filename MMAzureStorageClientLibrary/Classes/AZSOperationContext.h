...
@property (strong) NSMutableArray<AZSStorageCommand *> *commands;
...
@property (copy, AZSNullable) void(^didSendBodyData)(NSURLSessionTask *, int64_t, int64_t, int64_t);
...
@property (assign, readonly) BOOL isCancel;
